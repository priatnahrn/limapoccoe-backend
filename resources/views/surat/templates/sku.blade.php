...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            hr { margin: 4px 0; }
            table tr td:first-child { width: 170px; }
...
<div class="page">
    ...
    <p class="mt-2 indent">
        Benar nama tersebut di atas adalah penduduk Dusun {{ $data['dusun'] ?? optional($profile)->dusun ?? '-' }}, Desa Limapoccoe, Kecamatan Cenrana, Kabupaten Maros,
        yang memiliki usaha <strong>“{{ $data['nama_usaha'] ?? '-' }}”</strong> berlokasi di Dusun {{ $data['dusun_usaha'] ?? '-' }},
        Desa Limapoccoe, Kecamatan Cenrana, Kabupaten Maros.
    </p>

    <p class="indent">Demikian surat keterangan usaha ini kami berikan untuk dipergunakan sebagaimana mestinya.</p>
