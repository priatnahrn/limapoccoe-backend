...
<head>
    ...
    <style>
        ...
        /* label disempitkan supaya hemat tinggi total */
        table tr td:first-child { width: 200px; }
        table tr td:nth-child(2) { padding-left: 18px; }
...
<div class="page">
    ...
    <table style="margin-left:20px;">
        ...
        <tr>
            <td>Alamat</td>
            <td>: Dusun {{ $data['dusun'] ?? optional($profile)->dusun ?? '-' }}, {{ $data['alamat'] ?? optional($profile)->alamat ?? '-' }}</td>
        </tr>
    </table>

    <p class="mt-2 indent">Surat keterangan ini dibuat atas dasar yang sebenarnya.</p>
